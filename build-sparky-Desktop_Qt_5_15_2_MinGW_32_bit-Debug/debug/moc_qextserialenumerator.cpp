...
#include <memory>
#include "../../Sparky/3rdparty/qextserialport/qextserialenumerator.h"
...
struct qt_meta_stringdata_QextSerialRegistrationWidget_t {
    QByteArrayData data[1];
    char stringdata0[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QextSerialRegistrationWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QextSerialRegistrationWidget_t qt_meta_stringdata_QextSerialRegistrationWidget = {
    {
QT_MOC_LITERAL(0, 0, 28) // "QextSerialRegistrationWidget"
...
void QextSerialRegistrationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
QT_INIT_METAOBJECT const QMetaObject QextSerialRegistrationWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_QextSerialRegistrationWidget.data,
    qt_meta_data_QextSerialRegistrationWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QextSerialRegistrationWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QextSerialRegistrationWidget.stringdata0))
